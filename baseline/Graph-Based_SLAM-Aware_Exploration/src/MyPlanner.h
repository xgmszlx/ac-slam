...
private:
        ...
        int mActiveLoopVertex; // Observation only: vertex for the currently executing loop action
        bool mLoopExecutionStartLogged; // Observation only: avoid duplicate execution-start events
