...
def concorde_tsp_solver(distance_matrix: np.array, node_list: list, specify_end = False, seed = None):
    ...
    extra_args = []
    if seed is not None:
        extra_args = ["-s", str(int(seed))]
    solution = run_concorde(problem, extra_args=extra_args)
